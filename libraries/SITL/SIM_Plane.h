...
protected:
    ...
    struct {
        ...
        // thanks to Georacer!
        // http://georacer.github.io/last_letter/parameters/aircraftAeroParams.html
        // float s = 0.45;
        // float b = 1.88;
        // float c = 0.24;
        // float c_lift_0 = 0.56;
        ...
        // float c_drag_p = 0.1; // https://aerotoolbox.com/drag-polar/#the-drag-polar
        // float c_y_0 = 0;
        // float c_y_b = -0.98;
        // float c_y_p = 0;
        // float c_y_r = 0;
        ...
        float c = 0.28;
        float c_lift_0 = 0.35;
        float c_lift_deltae = 0.011;
        float c_lift_a = 5.82;
        float c_lift_q = 11.9;
        float mcoeff = 50;
        float oswald = 0.7;
        float alpha_stall = 0.3;
        float c_drag_q = 0;
        float c_drag_deltae = 0.0;
        float c_drag_p = 0.16; // https://aerotoolbox.com/drag-polar/#the-drag-polar
        float c_y_0 = 0;
        float c_y_b = -0.856;
        float c_y_p = 0.013;
        float c_y_r = 0.372;
        float c_y_deltaa = 0.0;
        float c_y_deltar = -0.004;
        float c_l_0 = 0;
        float c_l_p = -0.616;
        float c_l_b = -0.027;
        float c_l_r = 0.132;
        float c_l_deltaa = 0.439;
        float c_l_deltar = 0.0;
        float c_m_0 = 0.0;
        float c_m_a = -2.169;
        float c_m_q = -16.26;
        float c_m_deltae = 1.598;
        float c_n_0 = 0;
        float c_n_b = 0.163;
        float c_n_p = 0.038;
        float c_n_r = -0.09;
        float c_n_deltaa = -0.021;
        float c_n_deltar = 0.061;
        float deltaa_max = 0.3491;
        float deltae_max = 0.3491;
        float deltar_max = 0.3491;
